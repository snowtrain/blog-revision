...
SECRET_KEY = 'eh5$$5-5i0o8mdoi=ornm&)v$iwg)rmmxd-c+g9s8s*nh7_0yz'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'blog_online',  # 数据库名称
        'USER': 'webuser',  # 拥有者，这个一般没修改
        'PASSWORD': '123123',  # 密码，自己设定的
        'HOST': '192.168.10.11',  # 数据库所在IP
        'PORT': '5432',
    }
}
...
SITE_DESCRIPTION = "Ricky的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动，静静寻觅生活的美好"

SITE_KEYWORDS = "Ricky,静觅,网络,IT,技术,博客,Python"
