...
from storm.views import (IndexView, MessageView, AboutView, DonateView, ExchangeView, ProjectView, QuestionView,
                         MySearchView, LoveView, LinkView, DetailView, GirlfriendView)
...
urlpatterns = [
    ...
    url(r'^category/girlfriend/$', GirlfriendView, name='grilfriend'),
